<template>
  <footer class="pt-5 pb-10">
    <div class="container max-w-[640px]">
      <p class="flex items-center justify-center gap-1 text-white/90">
        Built with <a class="font-medium" href="https://nuxt.com/" target="_blank" rel="noopener">Nuxt.js</a>,
        <a class="font-medium" href="https://www.storyblok.com/" target="_blank" rel="noopener">Storyblok</a>
        and
        <a class="font-medium" href="https://tailwindcss.com/" target="_blank" rel="noopener">Tailwind.css</a>
        <svg class="ml-1" xmlns="http://www.w3.org/2000/svg" width="20px" height="18px" viewBox="0 -5.37 77.646 77.646">
          <defs>
            <linearGradient
              id="linear-gradient"
              x1="1.044"
