<template>
  <footer class="pt-5 pb-10">
    <div class="container max-w-[640px]">
      <div class="flex flex-col items-center justify-center gap-1 text-white/90 min-[600px]:flex-row">
        <p>Built with</p>
        <div>
          <a class="font-medium" href="https://nuxt.com/" target="_blank" rel="noopener">Nuxt.js</a>,
